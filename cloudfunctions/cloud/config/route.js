...
module.exports = { 
	...
	'passport/get_all_coach': 'passport_controller@getAllCoach',
	...
	'meet/coach_sign_in':'meet_controller@siginIn',
	...
	'activity/activity_list': 'activity_controller@getActivityList',
	'activity/activity_submit': 'activity_record_controller@insertActivityRecord',
	//***########### ADMIN ################## */  
	...
	'admin/coach_list': 'admin/admin_user_controller@getCoachList',
	'admin/user_detail': 'admin/admin_user_controller@getUserDetail',
	'admin/user_del': 'admin/admin_user_controller@delUser#noDemo',  
	'admin/user_can_use_num': 'admin/admin_user_controller@modifyUserCanUse',
	'admin/user_edit_class_type': 'admin/admin_user_controller@modifyUserClassType',
	'admin/user_edit_coach_place': 'admin/admin_user_controller@modifyCoachPlace',
	'admin/user_list_by_type': 'admin/admin_user_controller@getUserListByType',
	'admin/user_this_month_is_birth': 'admin/admin_user_controller@getToMonthIsBirthDay',
	'admin/coach_attendance':'admin/admin_user_controller@getCoachAttendance',
