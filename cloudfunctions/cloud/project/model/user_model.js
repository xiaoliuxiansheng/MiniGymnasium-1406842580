...
UserModel.DB_STRUCTURE = {
	...
	USER_TYPE: 'int|true|default=1|comment=用户类型 1=学员,2=教练',
	...
	USER_PLACE_ID: 'string|false|comment=教练所属场地Id',
	USER_PLACE_NAME: 'string|false|comment=教练所属场地name',
	USER_LOGIN_CNT: 'int|true|default=0|comment=登陆次数',
	USER_LOGIN_TIME: 'int|false|comment=最近登录时间',
	USER_BRITH: 'string|true|comment=生日',
	USER_ICON: 'array|true|comment=头像',
	USER_ADD_TIME: 'int|true',
	USER_ADD_IP: 'string|false',
	USER_COACH_TYPE: 'bool|true|default=false|comment=是否是私教',
	USER_CANUSE_COUNT: 'int|true|default=0|comment=积分剩余数',
	USER_EDIT_TIME: 'int|true',
	USER_EDIT_IP: 'string|false',
	USER_CLASS_TYPE: 'string|false|comment=学员课程类型'
}
