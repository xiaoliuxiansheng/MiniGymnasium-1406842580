...
MeetModel.DB_STRUCTURE = {
	...
	*/
	...
	MEET_PAY_TYPE: 'int|true|default=1|comment=消费方式 1=积分抵扣, 2=在线支付',
	MEET_PRICE: 'int|true|default=1|comment=消费数量 1=积分剩余, 2=在线支付金额',
	MEET_COACH_ID: 'string|false|comment=教练OPENID',
	MEET_CLASS_TYPE: 'string|false|comment=课程类型'
};
